...
class HitBTC(Bequant):
    ...
    websocket_endpoints = [
        WebsocketEndpoint(
            "wss://api.hitbtc.com/api/2/ws/public",
            channel_filter=(
        ...
        WebsocketEndpoint(
            "wss://api.hitbtc.com/api/2/ws/trading",
            channel_filter=(websocket_channels[ORDER_INFO],),
        ),
        WebsocketEndpoint(
            "wss://api.hitbtc.com/api/2/ws/account",
            channel_filter=(
    ...
    rest_endpoints = [
        RestEndpoint("https://api.hitbtc.com", routes=Routes("/api/2/public/symbol"))
    ]
